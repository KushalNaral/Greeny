                    ...
                    <div class="account-content">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group"><label class="form-label">name</label><input class="form-control" type="text" value="{{auth()->guard('vendor')->user()->name}}"></div>
                            </div>
                            <div class="col-md-6 col-lg-4">
                                <div class="form-group"><label class="form-label">Email</label><input class="form-control" type="email" value= "{{auth()->guard('vendor')->user()->email}}" > </div>
                            </div>
                            <div class="col-lg-2">
