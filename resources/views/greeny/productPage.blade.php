        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="details-gallery">
                    <div class="details-label-group"><label class="details-label new">new</label> <ul class="details-thumb">
                            <li><img src="{{asset ('images/product/01.jpg')}}"  alt="product"></li>
                            <li><img src="{{asset ('images/product/01.jpg')}}" alt="product"></li>
                            <li><img src="{{asset ('images/product/01.jpg')}}" alt="product"></li>
                            <li><img src="{{asset ('images/product/01.jpg')}}" alt="product"></li>
                            <li><img src="{{asset ('images/product/01.jpg')}}"  alt="product"></li>
                        </ul><label class="details-label off">-10%</label></div>
            ...
            <div class="col-lg-6">
                <ul class="product-navigation">
                    <li class="product-nav-prev"><a href="#"><i class="icofont-arrow-left"></i>prev product <span class="product-nav-popup"><img src="images/product/02.jpg" alt="product"><small>green chilis</small></span></a></li>
                    <li class="product-nav-next"><a href="#">next product <i class="icofont-arrow-right"></i><span class="product-nav-popup"><img src="images/product/03.jpg" alt="product"><small>green chilis</small></span></a></li>
                </ul>
...
<section class="news-part" style="background: {{asset('images/newsletter.jpg')}} no-repeat center;">
    <div class="container">
