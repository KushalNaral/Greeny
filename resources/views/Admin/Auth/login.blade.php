    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-sm-10 col-md-12 col-lg-12 col-xl-10">
                <div class="user-form-logo"><a href="{{route('adminDashboard')}}"><img src="{{asset('images/logo.png')}}" alt="logo"></a></div>
                <div class="user-form-card">
                    <div class="user-form-title">
                        <h2>welcome ADMIN!</h2>
                        <p>Use your credentials to access Admin page</p>
                    </div>
                    ...
                    <div class="user-form-group">
                        ...
                        <form class="user-form" action="{{route('adminLoggedIn')}}"  method="post">
                            @csrf
